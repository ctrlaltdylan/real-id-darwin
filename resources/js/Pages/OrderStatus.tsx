...
export default function OrderStatus() {
    const { checkId } = getQueryParams();

    useEffect(() => {
        console.log('Creating flow');
        console.log(checkId);
        window.RealID.createFlow({
            ...
            <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                <div className="max-w-xl">
                    ...
                    <p className="mt-2 text-base text-gray-500">
                        Your order #14034056 is being processed and will be with
                        you soon.
                    </p>

                    <div className="min-h-[500px]" id="real-id-check"></div>
