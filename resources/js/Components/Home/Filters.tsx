...
const sortOptions = [{ name: 'Newest', href: '#', current: false }];
const filters = [
    {
        id: 'status',
        name: 'Status',
...
function hydrateFilter(filter: string, value: string) {
    return filters
        .find((f) => f.id === filter)
...
export default function Filters({
    ...
    return (
        <div className="bg-white">
            ...
            {/* Filters */}
            <section aria-labelledby="filter-heading" className="mt-4">
                                                                    ...
                                                                    <div className="group grid size-4 grid-cols-1">
                                                                        <input
                                                                            ...
                                                                            onChange={(
                                                                                ...
                                                                                const isStatusActiveNow =
                                                                                    checkStatuses.includes(
                                                                                        option.value,
                                                                                    );
                                                                                let newCheckStatuses =
                                                                                    [
                                                                                        ...checkStatuses,
                                                                                    ];
                                                                                console.log(
